      ...
      <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form ">
               <form action="<?php echo base_url('index.php/Contractor_controller/Contractor_login_check')?>" method="post" name="login">
               ...
               Free Registration.. <a href="<?php echo base_url('index.php/Contractor_controller/contractor_register')?>">Register Here</a>
               <br><br>
               <center>
