   ...
   <br><br>
           ...
           <br><br>
               ...
               <form action="<?php echo base_url('index.php/Contractor_controller/contractor_update/'.$fetch->contractor_id)?>" method="post" name="login" enctype="multipart/form-data">
                     ...
                     <input type="text" name="name"  class="form-control my-input" id="name" placeholder="" value="<?php echo $fetch->c_name?>" style="width: 400px;border-radius: 15px;height: 40px;padding-left: 15px">
                  </div>
                  <div class="form-group">
                     <label>Email</label>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="phone"  class="form-control my-input" id="name" placeholder=""value="<?php echo $fetch->c_phone?>" style="width: 400px;border-radius: 15px;height: 40px;padding-left: 15px">
                  </div>
                  <div class="form-group">
