      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mx-lg-auto">
         <!--  <li class="nav-item active">
          ...
          <li class="nav-item @@services__active">
            <a class="nav-link" href="<?php echo base_url('index.php/Contractor_controller/Contractor_profile')?>">My Profile</a>
          </li>
            <li class="nav-item @@services__active">
            <a class="nav-link" href="<?php echo base_url('index.php/Contractor_controller/user_request')?>">User Request</a>
          </li>
          <li class="nav-item @@services__active">
            <a class="nav-link" href="<?php echo base_url('index.php/Contractor_controller/Construction_cost_details')?>">Uploaded Construction details</a>
          </li>
           <li class="nav-item @@services__active">
