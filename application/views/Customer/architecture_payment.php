...
<!------ Include the above in your HEAD tag ---------->
   ...
   <div class="col-md-6 offset-md-3">
                    ...
                    <hr class="my-5">
                    <?php
                    foreach ($booking_architecture as $fetch) 
                      # code...
                    ...
                    <div class="card card-outline-secondary">
                        <div class="card-body">
                            ...
                            <form class="form" role="form" autocomplete="off" method="post" action="<?php echo base_url('index.php/Customer_controller/payment_insert')?>">
                              ...
                              <input type="hidden" name="customer_id" value="<?php echo $fetch->ab_customer_id?>">
                               <input type="hidden" name="customer_email" value="<?php echo $fetch->ab_customer_email?>">
                                <input type="hidden" name="architecture_id" value="<?php echo $fetch->ab_architecture_id?>">
                                 <input type="hidden" name="ad_architecture_email" value="<?php echo $fetch->ad_architecture_email?>">
                            ...
                            <a href="<?php echo base_url('index.php/Customer_controller/My_Architecture_booking')?>">
