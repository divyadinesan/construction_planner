...
<br><br>
                ...
                <div class="contact-infos">
                    ...
                    <div class="single-contact-infos">
                        ...
                        <div class="text-box">
                            ...
                            <p> <a href="mailto:support@gmail.com"><?php echo $fetch->a_email?></a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-6 map">
            	<br><br><br>
            	<br><br><br>
                <img src="<?php echo base_url('Asset/Architecture/Architecture_image/'.$fetch->architecture_image)?>" style="width: 500px;height: 400px">
            </div>
            <div class="col-lg-6 form-inner-cont mt-lg-0 mt-sm-5 mt-4" style="background-color: grey;color: white">
                <form action="<?php echo base_url('index.php/Customer_controller/architecture_booking_insert')?>" method="post" class="signin-form">
                	<br>
                	<input type="hidden" name="architecture_id" id="w3lName" placeholder="Your name" value="<?php echo $fetch->architecture_id?>" style="color: black">
                	<input type="hidden" name="architecture_email" id="w3lName" placeholder="Your name" value="<?php echo $fetch->a_email?>" style="color: black">
                    <div class="form-input">
                    	<label>Architecture Name</label>
                        <input type="text" name="a_name" id="w3lName" placeholder="Your name" value="<?php echo $fetch->a_name?>" style="color: black">
                    </div>
                    <div class="form-input">
                    	<label>Architecture Experience</label>
                        <input type="text" name="a_experience" id="w3lName" placeholder="Your name" value="<?php echo $fetch->a_experience?>"style="color: black">
                    </div>
                    <?php
                    ...
                    <div class="form-input">
                    	<label>Enter Your Dream House Description</label>
                        <textarea name="customer_description" id="w3lMessage" placeholder="Your message" required=""style="color: black"></textarea>
                    </div>
...
<div style="padding-left: 100px">
 <div class="single-contact-infos">
                    ...
                    <?php
                    foreach ($architecture_review as $review) {
