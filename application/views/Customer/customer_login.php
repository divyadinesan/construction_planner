      ...
      <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form ">
               <form action="<?php echo base_url('index.php/Customer_controller/customer_login_check')?>" method="post" name="login">
               ...
               Free Registration.. <a href="<?php echo base_url('index.php/Customer_controller/Customer_register')?>">Register Here</a>
               <br><br>
               <center>
