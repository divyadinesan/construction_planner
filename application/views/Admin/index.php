...
<body>
    ...
    <!-- loading-gif Js -->
    <script src="<?php echo base_url('Asset/Admin/js/modernizr.js')?>"></script>
    <script>
    ...
    <!-- Graph -->
    <script src="<?php echo base_url('Asset/Admin/js/SimpleChart.js')?>"></script>
    <script>
        var graphdata4 = {
            linecolor: "Random",
            title: "Thursday",
    ...
    <!--// Graph -->
    <!-- Bar-chart -->
    <script src="<?php echo base_url('Asset/Admin/js/rumcaJS.js')?>"></script>
    <script src="<?php echo base_url('Asset/Admin/js/example.js')?>"></script>
    <!--// Bar-chart -->
    <!-- Calender -->
    <script src="<?php echo base_url('Asset/Admin/js/moment.min.js')?>"></script>
    <script src="<?php echo base_url('Asset/Admin/js/pignose.calender.js')?>"></script>
    <script>
        //<![CDATA[
        $(function () {
    ...
    <link href="<?php echo base_url('Asset/Admin/css/simplyCountdown.css')?>" rel='stylesheet' type='text/css' />
    <script>
        var d = new Date();
